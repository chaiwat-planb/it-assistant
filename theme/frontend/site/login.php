...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="social-auth-links text-center">
            <p>- หรือ -</p>
            <a href="http://localhost/it-assistant/backend/web/index.php?r=site/login" class="btn btn-block btn-social btn-microsoft btn-flat"><i class="fa fa-cog"></i>ผู้ดูแลระบบ</a>
        </div>
        <!-- /.social-auth-links -->
