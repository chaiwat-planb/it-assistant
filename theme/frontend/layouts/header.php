...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">ITA</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
...
<!--                            <img src="<?= $directoryAsset ?>/img/user2-160x160.jpg" class="img-circle"
                        ...
                        <li class="user-body">
                            <div class="col-xs-4 text-center">
                                <a href="#">อีเมล:<?= $identity = Yii::$app->user->identity->email; ?></a>
                            </div>
                        </li>
                        <!-- Menu Footer-->
